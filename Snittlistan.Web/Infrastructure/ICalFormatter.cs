...
namespace Snittlistan.Web.Infrastructure
{
        ...
        : BufferedMediaTypeFormatter
    {
        ...
        private static void WriteRoster(RosterCalendarEvent roster, TextWriter writer)
        {
            ...
            writer.WriteLine("DTSTART:" + string.Format("{0:yyyyMMddTHHmmssZ}", roster.Date));
            writer.WriteLine("DTEND:" + string.Format("{0:yyyyMMddTHHmmssZ}", roster.Date.AddMinutes(60 + 45)));
