    ...
    public class MatchResult_MatchCommentary : WebApiIntegrationTest
    {
        ...
        private static IEnumerable<TestCase> BitsMatchIdAndCommentaries
        {
            get
            {
                ...
                yield return new TestCase(3067035, 24, "10-10", "Matchen vanns redan efter 3 serier med resultatet 10-5.", "Serie 3 vanns med enbart 15 pinnar. Lidas (277), Traav (234) och Laxen (222) låg bakom serievinsten med sina fina resultat. Traav 692 (3), Laxen 676 (3), Lidas 637 (3), Hockey 537 (3), Hammarn 524 (3), Gurkan 516 (3), Sollan 506 (3), Solen 504 (3).");
                ...
                yield return new TestCase(3105692, 21, "16-4", "Motståndarna blev överkörda med resultatet 16-4. Serierna slutade 4-1 (1666-1512), 4-1 (1556-1501), 4-1 (1572-1446), 4-1 (1563-1465).", "I serie 1 stod Lidas (276) för utmärkt insats. Lidas och Hasse blev matchens viktigaste spelare med 4 vunna serier vardera. Grattis till Lidas som uppnådde magiska 1000 poäng! Lidas 1003, Tranan 864, Laxen 816, Traav 795, Hasse 770, Jansson 736, Norpan 696, Hockey 518 (3), Affe 159 (1).");
