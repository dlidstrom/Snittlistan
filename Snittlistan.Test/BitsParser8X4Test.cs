...
namespace Snittlistan.Test
{
    ...
    public class BitsParser8X4Test
    {
        ...
        public async Task CanFindName()
        {
            ...
            // Act
            var result = new BitsParser(playersTeamA).Parse(await BitsGateway.GetBitsMatchResult(3050651), Team);
        ...
        public async Task CanParseAlternateHomeTeamName()
        {
            ...
            // Act
            var result = new BitsParser(playersTeamA).Parse(await BitsGateway.GetBitsMatchResult(3048746), Team);
        ...
        public async Task CanParseAlternateAwayTeamName()
        {
            ...
            // Act
            var result = new BitsParser(playersTeamA).Parse(await BitsGateway.GetBitsMatchResult(3048747), Team);
        ...
        public async Task CanParseAlternateAwayTeamNameWithIf()
        {
            ...
            // Act
            var result = new BitsParser(playersTeamF).Parse(await BitsGateway.GetBitsMatchResult(3048477), Team);
        ...
        public async Task CanParseThreeSeries()
        {
            ...
            // Act
            var result = new BitsParser(players).Parse(await BitsGateway.GetBitsMatchResult(3067035), Team);
            Assert.That(result.TeamScore, Is.EqualTo(10));
        ...
        public async Task DoesNotParseUnfinishedGame()
        {
            ...
            // Act
            var result = new BitsParser(playersTeamA).Parse(await BitsGateway.GetBitsMatchResult(0), Team);
