...
namespace Snittlistan.Test
{
    public class BitsParser8X4Test
    {
        ...
        public BitsParser8X4Test()
        {
            playersTeamA = new[]
            {
                new Player("Mikael Axelsson", "e@d.com", Player.Status.Active, 0) { Id = "player-1" },
                new Player("Christer Liedholm", "e@d.com", Player.Status.Active, 0) { Id = "player-2" },
                new Player("Lars Öberg", "e@d.com", Player.Status.Active, 0) { Id = "player-3" },
                new Player("Hans Norbeck", "e@d.com", Player.Status.Active, 0) { Id = "player-4" },
                new Player("Mathias Ernest", "e@d.com", Player.Status.Active, 0) { Id = "player-5" },
                new Player("Torbjörn Jensen", "e@d.com", Player.Status.Active, 0) { Id = "player-6" },
                new Player("Alf Kindblom", "e@d.com", Player.Status.Active, 0) { Id = "player-7" },
                new Player("Peter Sjöberg", "e@d.com", Player.Status.Active, 0) { Id = "player-8" },
                new Player("Lennart Axelsson", "e@d.com", Player.Status.Active, 0) { Id = "player-9" },
                new Player("Lars Magnusson", "e@d.com", Player.Status.Active, 0) { Id = "player-10" }
            };
            playersTeamF = new[]
            {
                new Player("Kjell Persson", "e@d.com", Player.Status.Active, 0) { Id = "player-1" },
                new Player("Lars Öberg", "e@d.com", Player.Status.Active, 0) { Id = "player-2" },
                new Player("Tomas Gustavsson", "e@d.com", Player.Status.Active, 0) { Id = "player-3" },
                new Player("Thomas Wallgren", "e@d.com", Player.Status.Active, 0) { Id = "player-4" },
                new Player("Bengt Solvander", "e@d.com", Player.Status.Active, 0) { Id = "player-5" },
                new Player("Lars Magnusson", "e@d.com", Player.Status.Active, 0) { Id = "player-6" },
                new Player("Kjell Johansson", "e@d.com", Player.Status.Active, 0) { Id = "player-7" },
                new Player("Thomas Gurell", "e@d.com", Player.Status.Active, 0) { Id = "player-8" },
                new Player("Lars Norbeck", "e@d.com", Player.Status.Active, 0) { Id = "player-9" }
            };
        }
        ...
        public void CanParseThreeSeries()
        {
            ...
            var players = new[]
            {
                new Player("Daniel Solvander", "e@d.com", Player.Status.Active, 0) { Id = "player-1" },
                new Player("Daniel Lidström", "e@d.com", Player.Status.Active, 0) { Id = "player-2" },
                new Player("Thomas Gurell", "e@d.com", Player.Status.Active, 0) { Id = "player-3" },
                new Player("Lennart Axelsson", "e@d.com", Player.Status.Active, 0) { Id = "player-4" },
                new Player("Håkan Gustavsson", "e@d.com", Player.Status.Active, 0) { Id = "player-5" },
                new Player("Kjell Johansson", "e@d.com", Player.Status.Active, 0) { Id = "player-6" },
                new Player("Bengt Solvander", "e@d.com", Player.Status.Active, 0) { Id = "player-7" },
                new Player("Stefan Traav", "e@d.com", Player.Status.Active, 0) { Id = "player-8" },
                new Player("Matz Classon", "e@d.com", Player.Status.Active, 0) { Id = "player-9" }
            };
